...
export WDIR="/scratch/zt1/project/jpurcel8-prj/shared/slurm/bayesian_r"
# export R_SCRIPTS="1,2,3,4,5,6"
export R_SCRIPTS="9"
export R_DIR="set2"
export user="skfk"
export packages="packages_up.R"
...
for script in "${listOfScripts[@]}"; do
  ...
  sbatch --export=SCP_OUTPUT_SERVER,WDIR,R_SCRIPTS,R_DIR,user,script,CUR_RSCRIPT,tmpwd,packages ./sbatch.sh
done
